        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)->addIndexColumn()
                ->addColumn('type', function ($row) {
                    ...
                    if ($row->paidvia == 'Bank') {
                        return '<label class="label label-success">Bank Transfer</label>';
                    } elseif ($row->paidvia == 'Paypal') {
                        return '<label class="label label-primary">PayPal</label>';
                    } elseif ($row->txn_type == 'manual') {
                        return '<label class="label label-primary">' . ucfirst($row->paidvia) . '</label>';
                    }
