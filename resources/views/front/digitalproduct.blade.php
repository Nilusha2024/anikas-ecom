                      ...
                      <div class="col-sm-6 col-xs-12 col-md-8">
                        <div class="price-box price-box-border">
                          <span class="price price-main dtl-price-main">
                            ...
                            {{ $product->offer_price != 0 || $product->offer_price != '' ? sprintf("%.2f",$product->offer_price * $conversion_rate) :  sprintf("%.2f",$product->price * $conversion_rate)  }}
                          </span>
                          @if($product->offer_price)
                          <span class="margin-top-15 font-size-20 price-strike price-strike-main dtl-price-strike-main">
                            <i class="{{ session()->get('currency')['value'] }}"></i> {{ sprintf("%.2f",$product->price * $conversion_rate) }}
                          </span>
                          @endif
