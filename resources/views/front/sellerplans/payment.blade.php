    ...
    <div class="container">
        <div class="row">
            <div class="offset-lg-2 col-lg-8 col-sm-12 col-md-12 col-xs-12">
                ...
                @if(Cookie::get('discoun') != '' && sprintf("%.2f",currency($plan->price, $from = $defCurrency->currency->code, $to = session()->get('currency')['id'] , $format = false)) != sprintf("%.2f",currency(Cookie::get('discount') ?? 0, $from = $defCurrency->currency->code, $to = session()->get('currency')['id'] , $format = false)))
